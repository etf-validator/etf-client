...
/**
 * There is not yet a public instance that supports this version 2.1 feature
 * @author Jon Herrmann ( herrmann aT interactive-instruments doT de )
 */
public class TestRunTemplateTest {

    @Test
    void getTestRunTemplates() {
        final EtfEndpoint etfEndpoint = Constants.ETF_ENDPOINT;
        assertThrows(FeatureNotSupportedException.class, () -> {
            etfEndpoint.testRunTemplates();
        });
    }
}
